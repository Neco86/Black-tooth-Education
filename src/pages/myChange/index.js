...
import { RegisterWrapper,AddressWrapper,AgeWrapper,IntroWrapper,Button } from '../login/style'
...
class MyChange extends PureComponent{
render(){
         ...
         return(
            <div>
                ...
                <RegisterWrapper>
                    ...
                    <Link to='/home/myChange/next'>
                      <Button className='next'>确定修改</Button>
                    </Link>
                </RegisterWrapper>
            </div>
        )
...
export default connect(mapStateToProps,mapDispatchToProps)(MyChange);